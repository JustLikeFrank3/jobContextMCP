...
def get_star_story_context(
    ...
    The LLM uses this context to write the actual STAR answer — this tool
    ...
    company: optional — triggers company-specific framing hints
    ...
    # ── Personal stories: direct tag match + related tags ──
