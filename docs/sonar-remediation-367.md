...
| Eval page, S5131 | Remove the unused `updated_at` value from inline JavaScript. JSON encoding alone did not prevent a stored `</script>` sequence from ending the script element. |
